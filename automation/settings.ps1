...
$MODPACK_NAME = "Secret Cobblemon Society"

# Name of the Modpack in the ZIP File
$CLIENT_NAME = "Secret Cobblemon Society"
...
$CLIENT_FILE_DISPLAY_NAME = "Secret Cobblemon Society - $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Secret Cobblemon Society Server - $MODPACK_VERSION"
